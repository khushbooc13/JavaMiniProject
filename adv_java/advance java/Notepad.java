...
public class Notepad extends Frame implements ActionListener , TextListener
{
	...
	public Notepad(String str)
	{
		...
		editfind=new MenuItem("Find...");											//
		editfindnext=new MenuItem("Find Next");								//
		editreplace=new MenuItem("Replace...");								//
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getActionCommand().equals("Find..."))							//for editmenu find option
		{
			efd=new editfinddialog(this,"Find");
		}
		if(ae.getActionCommand().equals("Replace..."))					//for editmenu replace option
		{
			erd=new editreplacedialog(this,"Replace");
		}
	...
	public static void main(String args[])
	{
		...
		Notepad notepad=new Notepad("Notepad");							//creating object of notepad
	}
}
...
{
	Notepad refobj;																				//reference object to Notepad class
	MyWindowAdapter(Notepad obj)
	{
		refobj=obj;
	}
...
class editfinddialog extends Dialog implements ActionListener	//class for edit menu find option dialog
{
	Panel panel1;
	...
	editfinddialog(Frame parent,String title)	
	{
		super(parent,title);	
		setLayout(new FlowLayout());													//layout foredit menu find dialog
		setSize(400,150);																		//size for edit menu find dialog
		setVisible(true);
	
		panel1=new Panel();																	//editmenu find dialog box
		panel1.setLayout(new GridLayout(1,2,5,5));							//
		direction=new CheckboxGroup();											//
		up=new Checkbox("Up",direction,false);								//
		down=new Checkbox("Down",direction,true);						//
		panel1.add(up);																			//
		panel1.add(down);																	//
		...
		panel2.add(matchcase);															//
		panel2.add(panel1);																	//

		panel3=new Panel();																	//
		panel3.setLayout(new FlowLayout(FlowLayout.LEFT));		//
		findwhat=new Label("Findwhat : ");											//
		...
		cancel.addActionListener(this);												//adding action listener for cancel button in find dialof box 
	}
...
class editreplacedialog extends Dialog implements TextListener , ActionListener , ItemListener
{
	Panel panel1;
	Label findwhat;
	Label replacewith;
	...
	editreplacedialog(Frame parent,String title)
	{
		super(parent,title);
		setLayout(new GridLayout(1,1,5,5));
		setSize(300,150);
		...
		findwhattextfield=new TextField(20);										//
		replacewithtextfield=new TextField(20);									//
		panel1.add(findwhat);																//
		...
		panel3.add(matchcase,BorderLayout.SOUTH);					//
