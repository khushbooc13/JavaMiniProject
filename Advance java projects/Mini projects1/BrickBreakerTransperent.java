...
public class BrickBreakerTransperent extends JPanel implements KeyListener,ActionListener, Runnable
{
				// movement keys..
				...
				public BrickBreakerTransperent() 
						{
							addKeyListener(this);
							setFocusable(true);
							t = new Thread(this);
			 ...
			 public static void main(String[] args) 
						{
							...
							// Determine if the GraphicsDevice supports translucency.
								...
								BrickBreakerTransperent game = new BrickBreakerTransperent();
											...
											if (count == Brick.length) 
											{
											   ...
											   repaint();
												...
												Ball.y += movey;
														...
														{
															Thread.sleep(8);
														} catch (Exception ex) {}// try catch ends here
