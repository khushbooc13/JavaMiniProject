...
/*
<APPLET CODE = "traffic.class" WIDTH = "900" HEIGHT = "900">
</APPLET>
*/
...
g.setColor(Color.black);
g.setFont(f1);
g.drawString ("vivekanad clg bus",320,200);
}
if(a==2)//YELLOWSIGNAL
{
	g.setColor(Color.yellow);
...
g.setColor(Color.black);
g.setFont(f1);
g.drawString ("SCIENT clg bus",320,200);
...
g.setColor(Color.black);
g.setFont(f1);
g.drawString ("vivekanand clg bus",380,200);
